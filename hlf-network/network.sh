...
# file for creating the network is "docker-compose-iris-net.yaml" in the ``docker``
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_orderer.irisauth.com docker_peer0.org1.irisauth.com docker_peer0.org2.irisauth.com
...
COMPOSE_FILE_BASE=compose-iris-net.yaml
