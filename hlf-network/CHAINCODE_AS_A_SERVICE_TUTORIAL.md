...
export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/org1.irisauth.com/tlsca/tlsca.org1.irisauth.com-cert.pem
...
# invoke the function
peer chaincode query -C irischannel -n basicts -c '{"Args":["org.hyperledger.fabric:GetMetadata"]}' | jq
```
